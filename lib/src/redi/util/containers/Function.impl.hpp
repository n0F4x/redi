...
#ifdef REDI_TEMP_INVOKE_QUALS
  #error REDI_TEMP_INVOKE_QUALS should not be defined
#endif
#ifdef REDI_TEMP_CONST_REF
  #error REDI_TEMP_CONST_REF should not be defined
#endif

#ifndef REDI_TEMP_CONST
  #define REDI_TEMP_CONST
#endif
#ifndef REDI_TEMP_REF
  #define REDI_TEMP_REF
  #define REDI_TEMP_INVOKE_QUALS REDI_TEMP_CONST&
#else
  #define REDI_TEMP_INVOKE_QUALS REDI_TEMP_CONST REDI_TEMP_REF
#endif
        ...
        ) noexcept(REDI_TEMP_IS_NOEXCEPT) -> Result_T
        {
            if constexpr (uses_small_buffer_optimization_c<T, size_T, alignment_T>)
            {
                return std::invoke_r<Result_T>(
                    static_cast<T REDI_TEMP_INVOKE_QUALS>(*storage.template launder<T>()),
            ...
            else
            {
                ...
                return std::invoke_r<Result_T>(
                    ...
                    static_cast<T REDI_TEMP_INVOKE_QUALS>(*handle),
                    std::forward<Args_T>(args)...
                );
            }
        }
...
class Function<
    auto(FArgs_T...) REDI_TEMP_CONST_REF noexcept(REDI_TEMP_IS_NOEXCEPT)->Result_T,
    is_move_only_T,
    size_T,
    alignment_T> : public internal::FunctionBase   //
{
public:
    using Signature = auto(FArgs_T...) REDI_TEMP_CONST_REF noexcept(REDI_TEMP_IS_NOEXCEPT)
        -> Result_T;
...
private:
    ...
    REDI_TEMP_NAMESPACE::Invoker<size_T, alignment_T, Result_T, FArgs_T...> m_invoke;
...
#undef REDI_TEMP_REF
#undef REDI_TEMP_IS_NOEXCEPT
#undef REDI_TEMP_INVOKE_QUALS
#undef REDI_TEMP_CONST_REF
