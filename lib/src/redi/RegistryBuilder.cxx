...
redi::RegistryBuilder::RegistryBuilder(const allocator_type& allocator)
...
auto redi::RegistryBuilder::get_allocator() const noexcept -> allocator_type
{
    return m_injections.get_allocator();
}

auto redi::RegistryBuilder::build(
